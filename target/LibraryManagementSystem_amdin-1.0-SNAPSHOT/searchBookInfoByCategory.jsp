...
<h1>通过书类查找书目</h1>
<br/>
<form action="searchBookInfoByCategory_commit.jsp" method="post">
    <div class="input-group mb-3" class="form-group">
        <div class="input-group-prepend">
            <label class="input-group-text" for="id">书类id</label>
        </div>
        <input id="id" type="text" class="form-control" name="category_id" required>
