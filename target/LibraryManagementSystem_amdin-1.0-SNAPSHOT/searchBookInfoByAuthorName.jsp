...
<h1>通过作者查找书目</h1>
<br/>
<form action="searchBookInfoByAuthorName_commit.jsp" method="post">
    <div class="input-group mb-3" class="form-group">
        <div class="input-group-prepend">
            <label class="input-group-text" for="id">作者名</label>
        </div>
        <input id="id" type="text" class="form-control" name="author_name" required>
    </div>
