...
<h1>删除一本图书单本</h1>
<br/>
<form action="deleteSingle_book_commit.jsp" method="post">
    <div class="input-group mb-3">
        <div class="input-group-prepend">
            <label class="input-group-text" for="inputGroupInput">单个图书编号</label>
        </div>
        <input id="inputGroupInput" type="text" class="form-control"  name="serial">
    </div>
